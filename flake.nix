{
  ...
  inputs.homa.url = "github:nix-community/home-manager/release-24.11";
  inputs.homa.inputs.nixpkgs.follows = "v2405";

  outputs = {v2405, v2411, v2505, ...}@inputs: rec {
    ...
    nixosConfigurations.BO  = lib.os v2411 nixosModules.BO;
